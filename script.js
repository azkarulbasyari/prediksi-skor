const liveScheduleUrl = 'https://www.google.com/search?q=semua+jadwal+fifa+series+2026&oq=semua+jadwal+&gs_lcrp=EgZjaHJvbWUqBwgBEAAYgAQyBggAEEUYOTIHCAEQABiABDIHCAIQABiABDIGCAMQABgDMg0IBBAAGIMBGLEDGIAEMgcIBRAAGIAEMgYIBhAAGAMyBwgHEAAYgAQyBwgIEAAYgAQyBwgJEAAYgATSAQg0MTM5ajBqN6gCALACAA&sourceid=chrome&ie=UTF-8#sie=lg;/m/0r4xs1m;2;/m/030q7;mt;fp;1;;;;-1';

const matches = [
  { id: 1, group: 'Grup H', teamA: 'Spanyol', flagA: '🇪🇸', teamB: 'Arab Saudi', flagB: '🇸🇦', date: 'Minggu, 21 Juni 2026', time: '23.00 WIB', venue: 'Mercedes-Benz Stadium, Atlanta', status: 'Terjadwal' },
  { id: 2, group: 'Grup G', teamA: 'Belgia', flagA: '🇧🇪', teamB: 'Iran', flagB: '🇮🇷', date: 'Senin, 22 Juni 2026', time: '02.00 WIB', venue: 'Los Angeles Stadium', status: 'Terjadwal' },
  { id: 3, group: 'Grup H', teamA: 'Uruguay', flagA: '🇺🇾', teamB: 'Cape Verde', flagB: '🇨🇻', date: 'Senin, 22 Juni 2026', time: '05.00 WIB', venue: 'Miami Stadium', status: 'Terjadwal' },
  { id: 4, group: 'Grup G', teamA: 'Selandia Baru', flagA: '🇳🇿', teamB: 'Mesir', flagB: '🇪🇬', date: 'Senin, 22 Juni 2026', time: '08.00 WIB', venue: 'Kansas City Stadium', status: 'Terjadwal' },
  { id: 5, group: 'Grup J', teamA: 'Argentina', flagA: '🇦🇷', teamB: 'Austria', flagB: '🇦🇹', date: 'Selasa, 23 Juni 2026', time: '00.00 WIB', venue: 'Dallas Stadium', status: 'Terjadwal' },
  { id: 6, group: 'Grup I', teamA: 'Prancis', flagA: '🇫🇷', teamB: 'Irak', flagB: '🇮🇶', date: 'Selasa, 23 Juni 2026', time: '04.00 WIB', venue: 'MetLife Stadium, New York/New Jersey', status: 'Terjadwal' },
  { id: 7, group: 'Grup I', teamA: 'Norwegia', flagA: '🇳🇴', teamB: 'Senegal', flagB: '🇸🇳', date: 'Selasa, 23 Juni 2026', time: '07.00 WIB', venue: 'Levi\'s Stadium, San Francisco Bay Area', status: 'Terjadwal' },
  { id: 8, group: 'Grup K', teamA: 'Portugal', flagA: '🇵🇹', teamB: 'Uzbekistan', flagB: '🇺🇿', date: 'Rabu, 24 Juni 2026', time: '00.00 WIB', venue: 'Boston Stadium', status: 'Terjadwal' },
  { id: 9, group: 'Grup L', teamA: 'Inggris', flagA: '🏴', teamB: 'Ghana', flagB: '🇬🇭', date: 'Rabu, 24 Juni 2026', time: '03.00 WIB', venue: 'Philadelphia Stadium', status: 'Terjadwal' },
  { id: 10, group: 'Grup K', teamA: 'Kolombia', flagA: '🇨🇴', teamB: 'RD Kongo', flagB: '🇨🇩', date: 'Rabu, 24 Juni 2026', time: '09.00 WIB', venue: 'Houston Stadium', status: 'Terjadwal' }
];

const round16 = [
  { id: 1, date: 'Sabtu, 4 Juli 2026', time: '13.00 ET', venue: 'Houston Stadium (NRG), Houston' },
  { id: 2, date: 'Sabtu, 4 Juli 2026', time: '17.00 ET', venue: 'Philadelphia Stadium, Philadelphia' },
  { id: 3, date: 'Minggu, 5 Juli 2026', time: '16.00 ET', venue: 'New York New Jersey Stadium' },
  { id: 4, date: 'Minggu, 5 Juli 2026', time: '20.00 ET', venue: 'Mexico City Stadium (Azteca)' },
  { id: 5, date: 'Senin, 6 Juli 2026', time: '15.00 ET', venue: 'Dallas Stadium (AT&T), Arlington' },
  { id: 6, date: 'Senin, 6 Juli 2026', time: '17.00 ET', venue: 'Seattle Stadium (Lumen Field)' },
  { id: 7, date: 'Selasa, 7 Juli 2026', time: '12.00 ET', venue: 'Atlanta Stadium (Mercedes-Benz)' },
  { id: 8, date: 'Selasa, 7 Juli 2026', time: '16.00 ET', venue: 'BC Place, Vancouver' }
];
...
const topScorers = [
  ...
  { rank: 4, name: 'Erling Haaland', country: 'Norwegia', flag: '🇳🇴', goals: 2 },
  { rank: 4, name: 'Harry Kane', country: 'Inggris', flag: '🏴', goals: 2 }
];

const facts = [
  { icon: '🌎', title: '48 Tim, Terbesar Sepanjang Sejarah', text: 'Edisi 2026 pertama kali diikuti 48 negara, naik dari 32 tim di edisi-edisi sebelumnya.' },
  { icon: '🏟️', title: 'Tuan Rumah 3 Negara', text: 'Amerika Serikat, Kanada, dan Meksiko menjadi tuan rumah bersama untuk pertama kalinya.' },
  { icon: '🆕', title: 'Babak 32 Besar Baru', text: 'Format baru menambahkan babak 32 besar sebelum babak 16 besar, sehingga total ada 104 pertandingan.' },
  { icon: '🥅', title: 'Partai Final di MetLife', text: 'Final akan digelar 19 Juli 2026 di New York New Jersey Stadium (MetLife Stadium), berkapasitas lebih dari 82.000 penonton.' }
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Estadio Azteca', 'MetLife Stadium (New York/New Jersey)', 'AT&T Stadium', 'SoFi Stadium'],
    answer: 1
  },
  {
    question: 'Siapa pemain yang mencetak hattrick pertama di Piala Dunia 2026?',
  ...
  },
  {
    ...
    options: ['Babak 64 Besar', 'Babak 32 Besar', 'Babak 8 Besar', 'Babak Play-off'],
    answer: 1
  }
];
...
function renderSchedule(){
  ...
  const filteredMatches = matches.filter(match => {
    const text = `${match.group} ${match.teamA} ${match.teamB} ${match.date} ${match.time} ${match.venue}`.toLowerCase();
  ...
  if(filteredMatches.length === 0){
    scheduleGrid.innerHTML = '<div class="empty-box wide-empty">Pertandingan tidak ditemukan. Coba kata kunci lain.</div>';
  }
...
function updateScoreLabels(){
  ...
  const selectedMatch = matches.find(match => String(match.id) === String(matchSelect.value));
...
function renderStatistik(){
  ...
  scorerList.innerHTML = topScorers.map(p => `
...
function handleQuizAnswer(selectedIndex, btnEl){
  ...
  if(selectedIndex === q.answer){
    ...
    quizFeedbackEl.textContent = '❌ Kurang tepat, jawaban benar disorot hijau.';
...
function finishQuiz(){
  ...
  quizResults.push({ name: lastName, correct: quizScore, total: quizQuestions.length, createdAt: new Date().toLocaleString('id-ID') });
...
function nextFlagRound(){
  ...
  const wrongOptions = shuffleArray(flagBank.filter(f => f.name !== flagCurrent.name)).slice(0, 3);
  ...
  allOptions.forEach(opt => {
    ...
    btn.addEventListener('click', () => handleFlagAnswer(opt.name === flagCurrent.name, btn));
...
function endFlagGame(){
  ...
  flagResults.push({ name: lastName, score: flagScoreVal, createdAt: new Date().toLocaleString('id-ID') });
...
function renderPredictions(){
  ...
  if(predictions.length === 0){
    ...
    predictionList.textContent = 'Belum ada prediksi skor. Isi form di samping untuk mulai menebak.';
    return;
  }

  predictionList.className = 'list-box';
  predictionList.innerHTML = predictions.map(item => `
    <div class="item">
...
function renderChampions(){
  ...
  if(champions.length === 0){
    ...
    championList.textContent = 'Belum ada tebakan juara. Isi form di samping untuk mulai menebak.';
    return;
  }

  championList.className = 'list-box';
  championList.innerHTML = champions.map(item => `
    <div class="item">
      <b>${item.name}</b>
...
function renderLeaderboard(){
  ...
  const rows = Object.keys(points).map(name => ({ name, point: points[name], total: counts[name] }))
    .sort((a,b) => b.point - a.point);

  if(rows.length === 0){
    leaderboardBody.innerHTML = '<tr><td colspan="5">Belum ada data leaderboard. Mulai tebak skor, kuis, atau tebak bendera untuk muncul di sini.</td></tr>';
...
document.getElementById('resetBtn').addEventListener('click', function(){
  const yakin = confirm('Yakin ingin menghapus semua data prediksi? Tindakan ini tidak bisa dibatalkan.');
  if(!yakin) return;
...
const railSectionIds = ['jadwal', 'tebakskor', 'bracket', 'statistik', 'kuis', 'tebakbendera', 'leaderboard'];
